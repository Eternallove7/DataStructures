...
//        String expression = "1+((2+3+1)*4)-5";
        String expression = "2+5*10-6";
    ...
    public static List<String> parseSuffixExpressionList(List<String> ls){
        ...
        // 说明：因为s2这个栈，在整个转换说明中，没有pop操作，而且后面我们还需要逆序输出
        // 因此比较麻烦，这里就使用List<String> s2代替Stack
        ...
        return s2;// 因为是存放到List,因此按顺序输出就是对于的逆波兰表达式
    }
